...
public class StudentScoreCard extends javax.swing.JFrame {
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(StudentScoreCard.class.getName()).log(java.util.logging.Level.SEVERE,
					null, ex);
	...
	private void setStudentScoreCard() {
		
		List<Performance> performerList = PerformanceDao.getPerformerByUserId(UserProfile.getUserId());
...
//          JOptionPane.showMessageDialog(this, "Sorry! No student appeared to this paper yet.","Notification",JOptionPane.INFORMATION_MESSAGE);
			System.out.println("You haven't appeared in the any exam yet.");
			return;
		}
		...
		performerList.forEach(performer -> {
			row[0] = performer.getExam().getExamID();
			row[1] = performer.getRight();
			row[2] = performer.getWrong();
			row[3] = performer.getUnattemped();
			row[4] = performer.getPercentage();
			row[5] = performer.getExam().getSubject();
