...
public class ViewSingleStudentScoreFrame extends javax.swing.JFrame {
	...
	public ViewSingleStudentScoreFrame() {
		...
		UserDao.getUsersByType().stream().forEach(user -> jcStudentId.addItem(String.valueOf(user.getUserId())));
				...
				.addGroup(jPanel1Layout.createSequentialGroup().addGroup(jPanel1Layout
						...
						.addGroup(jPanel1Layout.createSequentialGroup().addGap(36, 36, 36)
								...
								.addGroup(jPanel1Layout
										...
										.addComponent(txtLanguage).addComponent(txtPercentage)
										.addComponent(jcExamId, 0, 226, Short.MAX_VALUE).addComponent(jcStudentId, 0,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
						.addGroup(jPanel1Layout.createSequentialGroup().addGap(136, 136, 136).addComponent(jLabel2)))
						.addGap(0, 0, Short.MAX_VALUE))
				.addGroup(jPanel1Layout.createSequentialGroup().addGap(134, 134, 134)
						.addComponent(btnBack, javax.swing.GroupLayout.PREFERRED_SIZE, 197,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel1Layout.createSequentialGroup().addGroup(jPanel1Layout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addComponent(lblLogout, javax.swing.GroupLayout.PREFERRED_SIZE, 36,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addGroup(jPanel1Layout.createSequentialGroup()
								...
								.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
										.addComponent(jcStudentId, javax.swing.GroupLayout.PREFERRED_SIZE, 35,
												javax.swing.GroupLayout.PREFERRED_SIZE)
								...
								.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
										.addComponent(jLabel4, javax.swing.GroupLayout.PREFERRED_SIZE, 38,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addComponent(jcExamId, javax.swing.GroupLayout.PREFERRED_SIZE, 38,
												javax.swing.GroupLayout.PREFERRED_SIZE))
								.addGap(32, 32, 32)
								.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
										.addComponent(jLabel5, javax.swing.GroupLayout.PREFERRED_SIZE, 41,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addComponent(txtLanguage, javax.swing.GroupLayout.PREFERRED_SIZE, 33,
												javax.swing.GroupLayout.PREFERRED_SIZE))))
						.addGap(24, 24, 24)
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jLabel6).addComponent(txtPercentage,
	...
	private void jcStudentIdActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jcStudentIdActionPerformed
		...
		String userId = jcStudentId.getSelectedItem().toString();

		List<Exam> examIds = ExamDao.getExamIdByUserForStudent(Integer.parseInt(userId));

		examIds.forEach(exam -> jcExamId.addItem(String.valueOf(exam.getExamID())));

		String examId = jcExamId.getSelectedItem().toString();

		Performance performance = PerformanceDao.getPerformanceByUserIdAndExamId(Integer.parseInt(userId),
				Integer.parseInt(examId));

		txtLanguage.setText(performance.getExam().getSubject());
		txtPercentage.setText(performance.getPercentage() + "");
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(ViewSingleStudentScoreFrame.class.getName())
